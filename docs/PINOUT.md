...
> Canonical source lives in the firmware repo:  
> [armband-ppg-940nm/PINOUT.md](https://github.com/Fryrocket/armband-ppg-940nm/blob/main/PINOUT.md)

Target: **Seeed XIAO ESP32C3**  
Firmware: `armband-ppg-940nm/firmware/Armband_Full.ino`  
...
Run the I²C scanner in the firmware `SETUP.md` before full assembly. Firmware stores the address that responds and uses it for INT1 config.
...
*BGM umbrella · Firmware source of truth: [armband-ppg-940nm/PINOUT.md](https://github.com/Fryrocket/armband-ppg-940nm/blob/main/PINOUT.md)*
